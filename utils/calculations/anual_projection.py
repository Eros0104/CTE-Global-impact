...
def calculate_anual_projection_by_percentage(percentage, kilometers):
  anual_total_passangers = 33632 * 1000
  formated_percentage = percentage * 0.01
  estimated_passengers = anual_total_passangers * formated_percentage
